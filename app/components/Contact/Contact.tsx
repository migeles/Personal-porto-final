...
import profilePicture from "../../assets/image/pp.webp";
...
export default function Contact() {
  ...
  return (
    <div
      id="contact"
      className="bg-[#121212] h-240 flex flex-col justify-between items-center pt-24 px-0 "
    >
      {/* Top Section: Profile & Call to Action */}
      <div className="bg-[#121212] flex flex-col items-center h-full w-full my-30 mb">
        {/* Profile Picture */}
        <img
        ...
        {/* Main Heading */}
        <h1 className="text-5xl md:text-[6.5rem] font-medium text-center leading-13 md:leading-28  mb-12 tracking-normal md:tracking-tight">
      ...
      {/* Footer Section */}
      <div className="w-full pb-8 bg-[#121212]">
        ...
        <div className="flex flex-col items-center md:hidden pb-8">
          ...
          <div className="flex gap-6 text-white text-base">
            <a
              href="https://www.instagram.com/migelss01/reels/"
              className="hover:text-[#DBFF12] transition-colors"
            >
              Instagram
            </a>
            <a
              href="https://www.linkedin.com/in/migel-sastrawan-sugiarto/"
              className="hover:text-[#DBFF12] transition-colors"
            >
              Linkedin
            </a>
